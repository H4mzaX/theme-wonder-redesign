...
const collectionDefs: Record<string, {
  ...
  "iphone-cases": {
    ...
    midBanner: {
      ...
      label: "Accessories",
      title: "iPhone\nAccessories",
      desc: "Keep your iPhone in optimal condition for years.",
      cta: "View Accessories",
      image: accessoriesImg,
    },
  },
  "samsung-cases": {
    title: "Galaxy Protection\nPerfected",
    subtitle: "SAMSUNG CASES",
    description: "Premium cases designed specifically for Samsung Galaxy devices. Precision fit, maximum impact protection.",
    ...
    midBanner: {
      ...
      label: "Earphones",
      title: "Earphones\nAccessories",
      desc: "Keep your earphones in optimal condition for years.",
      cta: "View Accessories",
      image: earImg,
    },
  },
  "oneplus-cases": {
    title: "Never Settle\nOn Protection",
    subtitle: "ONEPLUS CASES",
    description: "Bold protection for bold devices. Cases that match OnePlus's uncompromising quality.",
  ...
  "magsafe-cases": {
    title: "Snap-On\nPerfection",
    subtitle: "MAGSAFE CASES",
    description: "Perfectly aligned magnets for seamless charging and accessories. The future of phone cases.",
    heroImage: magsafeClearImg,
    ctaLabel: "View MagSafe",
  ...
  "leather-cases": {
    ...
    description: "Premium leather that ages beautifully. Each case develops a unique patina over time.",
    heroImage: leatherBrownImg,
    ctaLabel: "View Leather",
  ...
  all: {
    title: "All Products",
    subtitle: "COLLECTION",
    description: "Browse our complete collection of premium phone cases and accessories.",
    heroImage: collectionHero,
    ctaLabel: "Browse All",
    filter: () => true,
    subcategories: [
    ...
    midBanner: {
      ...
      label: "Accessories",
      title: "Phone\nAccessories",
      desc: "Grips, mounts, chargers & more for your devices.",
      cta: "View Accessories",
      image: accessoriesImg,
    },
  },
