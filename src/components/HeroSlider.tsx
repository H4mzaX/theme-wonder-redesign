...
const HeroSlider = () => {
  ...
  return (
    <section className="px-4 sm:px-6 lg:px-0 pt-2 sm:pt-4 lg:pt-0">
      <div className="lg:max-w-none max-w-[1400px] mx-auto">
        <div className="relative overflow-hidden rounded-2xl sm:rounded-3xl lg:rounded-none">
