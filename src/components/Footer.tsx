  ...
  return (
    <footer className="bg-foreground text-background">
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-10 py-8 sm:py-10">
        <StaggerGroup className="grid grid-cols-2 sm:grid-cols-4 gap-8 lg:gap-10" staggerDelay={0.08}>
          <StaggerChild className="col-span-2 sm:col-span-1">
        ...
        <AnimateElement type="fade" className="border-t border-background/10 mt-6 pt-4">
